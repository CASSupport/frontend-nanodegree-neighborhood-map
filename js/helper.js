...
function initializeMap(viewModel) {
	...
	*/
	...
	if (locations.length > 0) {
		...
		// No locations found, set the default extents
		console.log("no locations to display on map");
		// window.mapBounds = new google.maps.LatLng(39.5936467,-104.8169522);
		viewModel.map = new google.maps.Map(document.getElementById('map-div'), {
            center: new google.maps.LatLng(39.5933128,-104.8091519),
            zoom: 16
        });
	}
